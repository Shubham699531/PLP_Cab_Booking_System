...
@NamedQuery(name = "updateDriverStatus", query = "UPDATE Driver SET driverStatus=:status WHERE driverId=:id")
@NamedQuery(name = "fetchDriverByVehicleNo", query = "FROM Driver WHERE vehicleNo=:vehicleNo")
